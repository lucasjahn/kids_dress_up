...
onready var deleteButton = sceneRoot.get_node('MainSceneContainer/ButtonRightContainer/VBoxContainer/ButtonsBotton/ButtonDelete') if sceneRoot.has_node('MainSceneContainer/ButtonRightContainer/VBoxContainer/ButtonsBotton/ButtonDelete') else null
